...
const inputClass = 'h-12 rounded-2xl border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#1f232b] outline-none transition placeholder:text-[#1f232b]/40 focus:border-[#1f232b]/40 focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-[var(--slot4-accent-fill)] px-6 text-sm font-black uppercase tracking-[0.22em] text-white transition hover:-translate-y-0.5 hover:opacity-95 disabled:opacity-60'
